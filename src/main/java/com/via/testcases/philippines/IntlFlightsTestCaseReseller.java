...
public class IntlFlightsTestCaseReseller {
    ...
    @DataProviderParameters(path = Constant.PH_FLIGHTS_TESTDATA, sheetName = Constant.FLIGHTS_INTL_RESELLER_SHEETNAME)
    public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
        ...
        flightTestExecuter.execute(testId, driver, repositoryParser, Country.PHILIPPINES, Flight.INTERNATIONAL,
                testData);
    }
