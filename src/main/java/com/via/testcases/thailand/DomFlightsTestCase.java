...
public class DomFlightsTestCase {
    ...
    @DataProviderParameters(path = Constant.TH_FLIGHTS_TESTDATA, sheetName = Constant.FLIGHTS_DOMESTIC_SHEETNAME)
    public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
        ...
        flightTestExecuter.execute(testId, driver, repositoryParser, Country.THAILAND, Flight.DOMESTIC, testData);
    }
