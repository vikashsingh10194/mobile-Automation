...
public class IntlFlightsTestCase {
    ...
    @DataProviderParameters(path = Constant.SAUDI_FLIGHTS_TESTDATA, sheetName = Constant.FLIGHTS_INTL_SHEETNAME)
    public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
        ...
        flightTestExecuter.execute(testId, driver, repositoryParser, Country.SAUDI, Flight.INTERNATIONAL, testData);
    }
