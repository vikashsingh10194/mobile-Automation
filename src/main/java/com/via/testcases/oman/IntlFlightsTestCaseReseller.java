...
public class IntlFlightsTestCaseReseller {
    ...
    @DataProviderParameters(path = Constant.OMAN_FLIGHTS_TESTDATA, sheetName = Constant.FLIGHTS_INTL_RESELLER_SHEETNAME)
    public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
        ...
        flightTestExecuter.execute(testId, driver, repositoryParser, Country.OMAN, Flight.INTERNATIONAL, testData);
    }
}
