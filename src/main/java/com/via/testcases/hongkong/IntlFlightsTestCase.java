...
public class IntlFlightsTestCase {
    ...
    @DataProviderParameters(path = Constant.HONGKONG_FLIGHTS_TESTDATA, sheetName = Constant.FLIGHTS_INTL_SHEETNAME)
    public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
        ...
        flightTestExecuter.execute(testId, driver, repositoryParser, Country.HONGKONG, Flight.INTERNATIONAL, testData);
    }
